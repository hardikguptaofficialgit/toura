    ...
    <div className="space-y-6 pb-6">
      ...
      <div>
        ...
        <textarea
          ...
          placeholder="e.g., I want to explore ancient ruins, try local cuisine, and relax on beautiful beaches for 5 days in Greece..."
          rows={4}
      ...
      <div>
        ...
        <input
          ...
          placeholder="e.g., Santorini, Japan, New York..."
